...
![](Plots_files/figure-gfm/1-cells%20plot-1.png)<!-- -->
...
![](Plots_files/figure-gfm/2-fcm%20plot-1.png)<!-- -->
...
![](Plots_files/figure-gfm/3-frr%20plot-1.png)<!-- -->
...
```
    ...
    ```{r,ap plot, fig.asp=0.3, fig.width=30}
